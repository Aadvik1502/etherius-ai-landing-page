...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Learn how to choose the right AI consulting firm and avoid costly mistakes. Expert guide covers the 7 evaluation criteria, red flags, vetting questions, and decision framework that ensures you partner with consultants who deliver 240% ROI.",
    author: "Aadvik Bagga, Founder",
    date: "2025-10-07",
  ...
  },
  {
    ...
    excerpt: "Master the exact framework for calculating AI ROI that CFOs actually believe. Includes complete formulas, real examples with numbers, 3 detailed case studies, and a practical calculator to model your AI investment returns accurately.",
    author: "Aadvik Bagga, Founder",
    date: "2025-10-06",
